...
#. 6.scissors,paper and rock game:
import random
choices =["R","S","P"]
...
# 7.calculate the average using for loops:
...
8.highest among the list using for loops:
...
# 8. add even numbers from 1 to 100:
total =0
even_numbers =''
for num in range(1,101):
    if num%2 ==0:
...
# 10. A simple password Generator
